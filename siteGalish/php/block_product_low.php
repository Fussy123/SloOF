...
if ($result->num_rows > 0) {
    while ($productRow = $result->fetch_assoc()) {
        echo '<a class="squere2" href="' . "Page_product/product.php?product_id=" . $productRow["product_id"] . '">';
        echo '<img class="squere2_img" src="' . $productRow["img"] . '" alt="" width="300" height="300" style="border-radius: 20px;">';
