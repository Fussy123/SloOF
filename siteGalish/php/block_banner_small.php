...
$selectedProductIds = array_slice($productIds, 0, 3);
...
if ($result->num_rows > 0) {
    while ($productRow = $result->fetch_assoc()) {
        echo '<a class="squere4" href="' . "product_id_" . $productRow["id"] . '">';
        echo '<img class="squere4_img" src="' . $productRow["img"] . '" width="410px" height="180px" style="border-radius: 40px;">';;
        echo '</a>';
    }
} else {
    echo "Упс...";
