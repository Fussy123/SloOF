...
<body>
    ...
    <div class="intro__container">
        <div class="main__head">
            <h1 class="discount">Тут что-то должно было быть...<br>Но нам лень доделывать :)</h1>
        </div>
    </div>
        ...
        <div class="footer__container">
            <div class="footer__contact">
                <h1 class="contact">Покупатели
                    <a class="contact_dir">Как сделать заказ</a>
                    <a class="contact_dir">Способы Оплаты</a>
                </h1>
                <h1 class="contact">Партнерам
                    <a class="contact_dir">Продавайте на SLO.OF!</a>
                    <a class="contact_dir">Курьерам</a>
                    <a class="contact_dir">Перевозчикам</a>
                </h1>
                <h1 class="contact">Компания
                    <a class="contact_dir">О нас</a>
                    <a class="contact_dir">Реквизиты</a>
                </h1>
