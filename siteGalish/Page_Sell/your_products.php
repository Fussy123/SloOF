...
<body>
    ...
    <main>
        <div class="seller_form">
            <a class="button_seller" href="Create_your_products.php"> Зарегистрировать товар </a>
            <a class="button_seller" href="Create_your_banner.php"> Зарегистрировать рекламный баннер </a>
        </div>
        <div class="categ">
            <div class="categ_text">
                Ваши размещенные товары
            </div>
            <?php
            // Добавить содержимое вашего PHP-файла
            include('../php/block_product_author.php');
            ?>
                        <div class="categ_text" style="padding-top: 20px;">
                Ваши размещенные баннеры
            </div>
            <?php
            // Добавить содержимое вашего PHP-файла
            include('../php/block_banner_author.php');
            ?>
